...
function setup() {
  ...
  box20= new RedBox(560,280,20,30);

  box21= new GreenBox(550,220,20,30);

  box22= new GreenBox(500,135,20,30);
  box23 = new BlueBox(510,135,20,30);
  box24= new YellowBox(520,135,20,30);
  box25 = new RedBox(530,135,20,30);
  box26= new GreenBox(540,135,20,30);
  box27= new YellowBox(550,135,20,30);
  ...
  box33= new YellowBox(520,70,20,30); 
  box34 = new BlueBox(540,70,20,30); 
  box35= new RedBox(560,70,20,30); 
  box36= new GreenBox(580,70,20,30); 
